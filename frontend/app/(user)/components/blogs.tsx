    ...
    <section className="px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32 py-6 bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="relative mb-14">
        <h2 className="text-3xl lg:text-4xl font-extrabold text-gray-900 text-center">
          ⭐ Latest <span className="text-[#E53935]">Blogs</span>
        </h2>
        ...
        <div className="absolute right-0 top-1/2 transform -translate-y-1/2 hidden lg:block">
          <Link
            href="/blogs"
            className="inline-flex items-center gap-1 px-5 py-2 rounded-full bg-red-500 text-white font-semibold shadow-md hover:bg-red-700 transition-colors"
          >
          ...
          >
            <div className="bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col">
              ...
              <div className="p-5 flex flex-col flex-grow">
                <h3 className="text-lg font-semibold mb-2 line-clamp-2 text-gray-900 group-hover:text-[#E53935] transition-colors">
                  {post.title}
                </h3>
                {post.excerpt && (
                ...
                {/* CTA */}
                <span className="mt-auto inline-flex items-center gap-1 text-sm font-medium text-[#E53935] group-hover:gap-2 transition-all">
