...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <Link href={`/products/${slugify(product.name)}/${product.id}`}>
      <div
        className={`group relative bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-500 hover:shadow-xl hover:-translate-y-1 ${viewMode === "list" ? "flex items-start p-4" : "flex flex-col"
          }`}
      >
        {/* Discount Badge */}
        {discountPercent > 0 && (
        ...
        >
          ...
          {/* <div className="absolute bottom-3 left-0 right-0 flex justify-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            ...
            <button
              className={`bg-[#E53935] text-white p-2 rounded-full shadow-md hover:bg-[#E53935] hover:scale-105 transition-all duration-200 flex items-center justify-center ${
        ...
        >
          {/* Category Badge */}
          <span className="inline-block px-2 py-1 text-xs font-medium text-white bg-[#E53935] rounded-full capitalize mb-2">
            {product.Category?.name || "General"}
          </span>

          {/* Product Name */}
          <h3
            className={`font-medium text-gray-800 group-hover:text-red-600 transition-colors duration-300 line-clamp-2 ${viewMode === "list" ? "text-lg" : "text-sm leading-tight"
              }`}
          >
            {product.name}
          </h3>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-1">
              {[...Array(5)].map((_, i) => (
                <Star
                  key={i}
                  size={12}
                  className={`${i < 4 // Using a fixed 4-star rating for now
            ...
            {/* Stock Status */}
            <span
              className={`text-xs font-medium ${product.stock > 0 ? "text-red-600" : "text-gray-500"
                }`}
            >
          ...
          <div className="flex items-center justify-between">
            ...
            {/* Add to Cart Button */}
            <button
              className={`p-2 rounded-lg transition-colors duration-200 group/cart ${product.sold_out === 1
                ? "bg-gray-300 text-gray-500 cursor-not-allowed"
                : "bg-[#E53935] text-white hover:bg-[#E53935] hover:scale-105"
                }`}
              disabled={product.sold_out === 1}
            >
              <ShoppingCart
...
const FilterSidebar: React.FC<FilterSidebarProps> = ({
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed lg:sticky top-0 left-0 h-screen lg:h-auto w-80 bg-white z-50 lg:z-auto transform transition-transform duration-300 overflow-y-auto ${isOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"
          }`}
      >
        <div className="p-6 border-r border-gray-100 h-full lg:h-auto">
                ...
                categories.map((cat) => (
                  ...
                  >
                    <input
                      ...
                      className="w-4 h-4 text-[#E53935] border-gray-300 focus:ring-red-500"
                    />
                    <span className="ml-3 text-gray-700 group-hover:text-[#E53935] transition-colors">
                      {cat.name}
                    </span>
                  </label>
                ))}
              ...
              {[4, 3, 2, 1].map((stars) => (
                ...
                >
                  <input
                    ...
                    className="w-4 h-4 text-[#E53935] border-red-300 focus:ring-red-500"
                  />
                  <div className="ml-3 flex items-center">
                    ...
                    <span className="ml-2 text-gray-700 group-hover:text-[#E53935] transition-colors">
                      & up
                    </span>
                  </div>
                </label>
          ...
          <div className="mb-8">
            ...
            <select
              ...
              className="w-full p-3 border-2 border-red-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-[#E53935]"
            >
            ...
            <div className="flex flex-wrap items-center justify-between mb-6 p-4 bg-white rounded-xl shadow-sm gap-4">
              <div className="flex items-center gap-4">
                <button
                  ...
                  className="lg:hidden flex items-center gap-2 px-4 py-2 bg-[#E53935] text-white rounded-lg hover:bg-[#E53935] transition-colors"
                >
              ...
              <div className="flex-1 max-w-md">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-red-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-[#E53935] transition-all duration-300 outline-none"
                  />
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                <select
                  value={sortBy}
                  onChange={(e) => setSortBy(e.target.value)}
                  className="p-2 border border-red-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-[#E53935] text-sm outline-none transition-all duration-300"
                >
                ...
                <div className="flex items-center gap-2 p-1 bg-gray-100 rounded-lg">
                  <button
                    ...
                    className={`p-2 rounded-md transition-all duration-200 ${viewMode === "grid"
                      ? "bg-white shadow-sm text-[#E53935]"
            ...
            {!isLoading && filteredProducts.length === 0 && (
              <div className="text-center py-12">
                ...
                <button
                  ...
                  className="px-6 py-2 bg-red-500 text-white rounded-lg hover:bg-red-700 transition-colors hover:scale-105"
                >
                  Clear Filters
                </button>
              </div>
